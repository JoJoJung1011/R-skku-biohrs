...
|4|   9월 20일| R 데이터 매니지먼트: [data.table](https://blog.zarathu.com/posts/2022-02-11-datatable/), [code](code/datatable.R), [슬라이드](https://sehee-lim.github.io/R-skku-biohrs/data.table/)|
...
|11|  11월 8일| R 통계(3): [비선형모형: GAM](https://jinseob2kim.github.io/R-skku-biohrs/gam), [성향점수 매칭, 가중치](https://jinseob2kim.github.io/lecture-general/KSIC2025), [국건영데이터 소개](https://knhanes.kdca.go.kr/knhanes/sub03/sub03_01.do), [code](code/KNHANES.R) |
